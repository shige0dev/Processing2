  ...
  {    
   ...
   switch(_params.waveform1){
     case 0:
         ...
         osc1.patch(bitcrush1).patch( adsr1 );
     ...
     case 4:
         ...
         noise1.patch(bitcrush1).patch(mfilter1).patch( adsr1 );
   ...
   switch(_params.waveform2){
     case 0:
         ...
         osc2.patch(bitcrush2).patch( adsr2 );
     ...
     case 4:
         ...
         noise2.patch(bitcrush2).patch(mfilter2).patch( adsr2 );
