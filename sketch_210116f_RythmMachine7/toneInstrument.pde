class ToneInstrument implements Instrument
{
  ...
  Oscil osc1, osc2;
  Noise noise1,noise2;
  ADSR  amp_adsr0,amp_adsr1,mod_adsr1;
  ...
  { 
    ...
    amp_adsr1 = new ADSR( 1, _params.a1, _params.d1, _params.s1, _params.r1 );
...
//    float[] sawVal= {-1.0,-1.0, 0.0 , 1.0, -1.0};
    float[] sawVal= { -1.0, -0.9, 0.0,  0.9, 1.0};
    Wavetable wavetable =  new Wavetable(sawVal);
    distotion = new WaveShaper(1.0, 1.1, wavetable  );   
