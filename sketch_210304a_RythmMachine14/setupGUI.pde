...
void setGUIValue(){
    //println("setValue");
    WaveForm1.setValue(params[Number][0].waveform1 );
    Amp1.setValue(params[Number][0].amp1 );
    Freq1.setValue(params[Number][0].freq1 );
    A1.setValue(params[Number][0].a1 );
    D1.setValue(params[Number][0].d1 );
    ModForm1.setValue(params[Number][0].modform1 );
    ModAmp1.setValue(params[Number][0].modamp1);
    ModFreq1.setValue(params[Number][0].modfreq1);
    BitCrush1.setValue(params[Number][0].bitcrush1);
    OverDrive1.setValue(params[Number][0].overdrive1);
    Fold1.setValue(params[Number][0].fold1);
   // Pan1.setValue(_params1.pan1);

    WaveForm2.setValue(params[Number][1].waveform1 );
    Amp2.setValue(params[Number][1].amp1 );
    Freq2.setValue(params[Number][1].freq1 );
    A2.setValue(params[Number][1].a1 );
    D2.setValue(params[Number][1].d1 );
    ModForm2.setValue(params[Number][1].modform1 );
    ModAmp2.setValue(params[Number][1].modamp1);
    ModFreq2.setValue(params[Number][1].modfreq1);
    BitCrush2.setValue(params[Number][1].bitcrush1);
    OverDrive2.setValue(params[Number][1].overdrive1);
    Fold2.setValue(params[Number][1].fold1);
}

void getGUIValue() {
    //println("getValue");
    params[Number][0].waveform1 = int(WaveForm1.getValue());
    params[Number][0].amp1 = Amp1.getValue();
    params[Number][0].freq1= Freq1.getValue();
    params[Number][0].a1 = A1.getValue();
    params[Number][0].d1 = D1.getValue();
    //s1 = S1;
    //r1 = R1;
    params[Number][0].modform1 = int(ModForm1.getValue());
    params[Number][0].modamp1  = ModAmp1.getValue();
    params[Number][0].modfreq1 = ModFreq1.getValue();
    params[Number][0].bitcrush1 = BitCrush1.getValue();
    params[Number][0].overdrive1 = OverDrive1.getValue();
    params[Number][0].fold1 = Fold1.getValue();    
  //  pan1 = Pan1.getValue();
    params[Number][1].waveform1 = int(WaveForm2.getValue());
    params[Number][1].amp1 = Amp2.getValue();
    params[Number][1].freq1= Freq2.getValue();
    params[Number][1].a1 = A2.getValue();
    params[Number][1].d1 = D2.getValue();
    //s1 = S1;
    //r1 = R1;
    params[Number][1].modform1 = int(ModForm2.getValue());
    params[Number][1].modamp1  = ModAmp2.getValue();
    params[Number][1].modfreq1 = ModFreq2.getValue();
    params[Number][1].bitcrush1 = BitCrush2.getValue();
    params[Number][1].overdrive1 = OverDrive2.getValue();
    params[Number][1].fold1 = Fold2.getValue();    
  //  pan1 = Pan1.getValue();  
