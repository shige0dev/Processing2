...
//   delay = new Delay( 0.4, 0.5, true, true );
    ...
    switch(ModForm1){
     case 1:
      lfo1 = new Oscil( _params.modfreq1, _params.modamp1, Waves.SINE);    lfo1.patch(sum1);
      const1 = new Constant( _params.freq1 );    const1.patch(sum1);
     break;
     case 2:
      lfo1 = new Oscil( _params.modfreq1, _params.modamp1, Waves.SQUARE);    lfo1.patch(sum1);     
      const1 = new Constant( _params.freq1 );    const1.patch(sum1);
     break;
     case 3:
      lfo1 = new Oscil( _params.modfreq1, _params.modamp1, Waves.SAW);    lfo1.patch(sum1);   
      const1 = new Constant( _params.freq1 );    const1.patch(sum1);
     break;
    }
    switch(ModForm2){
     case 1:
      lfo2 = new Oscil( _params.modfreq2, _params.modamp2, Waves.SINE);    lfo2.patch(sum2);
      const2 = new Constant( _params.freq2 );    const2.patch(sum2);
     break;
     case 2:
      lfo2 = new Oscil( _params.modfreq2, _params.modamp2, Waves.SQUARE);    lfo2.patch(sum2);     
      const2 = new Constant( _params.freq1 );    const1.patch(sum1);
     break;
     case 3:
      lfo2 = new Oscil( _params.modfreq2, _params.modamp2, Waves.SAW);    lfo2.patch(sum2);   
      const2 = new Constant( _params.freq2 );    const1.patch(sum2);
     break;
    }    
    sum2 = new Summer();
    lfo2 = new Oscil( _params.modfreq2, _params.modamp2, Waves.SINE);    lfo2.patch(sum2);
   ...
   switch(WaveForm1){
     case 0:
         ...
         osc1.patch( adsr1 );
         sum1.patch(midi2hz1).patch(osc1.frequency);
     ...
     case 4:
         ...
         sum1.patch(midi2hz1).patch(mfilter1.frequency);
   ...
   switch(WaveForm2){
     case 0:
         ...
         osc2.patch( adsr2 );
         sum2.patch(midi2hz2).patch(osc2.frequency);         
     break;
     case 1:
     ...
     case 4:
         ...
         sum2.patch(midi2hz2).patch(mfilter2.frequency);           
     break;
     case 5:
         noise2 = new Noise(_params.amp2);
